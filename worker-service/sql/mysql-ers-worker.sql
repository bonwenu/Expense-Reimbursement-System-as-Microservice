...
insert into worker (last_name, first_name, username, pass_code, title, reports_to, hire_date, street_address, city, state, zip, phone, email) values ('Ten', 'Ben', 'benjamin721', 'benchee5151', 'Data Coordiator', 10, '1/1/2019', '41 Randy Pass', 'Boston', 'Massachusetts', '02124', '611-772-4221', 'bpavluk2@admin.ch');
...
insert into worker (last_name, first_name, username, pass_code, title, reports_to, hire_date, street_address, city, state, zip, phone, email) values ('Dover', 'Gwen', 'benjamin720', 'benchee5050', 'Manager', 0, '1/1/2016', '43255 Pennman', 'St Louis', 'Missouri', '77544', '617-772-4221', 'ben10@yahoo.com');
